-- ===========================================================================
-- KONVO — schema completo
--
-- COMO USAR: copie este arquivo INTEIRO, cole no SQL Editor do Supabase
-- (New query) e clique em Run. Uma vez só.
--
-- Gerado a partir de supabase/migrations/. Para mudar algo, edite as
-- migrations e rode: bun run schema
-- ===========================================================================
